...
def init_battle():
    ...
    if typ == 11:
        emy_lifemax = 60*(35)+(lev-1)*10
        emy_str = int(emy_lifemax/8)
    elif typ == 12:
        emy_lifemax = 300*(typ) + floor*50
        emy_str = 30 + floor*5
...
def load_game(filename="savefile.json"):
    global floor, pl_x, pl_y, pl_d, pl_a, pl_lifemax, pl_life, pl_str, pl_lv
    global food, potion, blazegem, pl_def_base, pl_def_buff, def_pill, dungeon
    global info_message, info_timer
    try:
