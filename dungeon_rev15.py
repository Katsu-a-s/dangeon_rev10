...
def move_player(key):
    ...
    global pl_def, def_pill, flg_action
...
def draw_para(bg, fnt):
    ...
    draw_text(bg, f"Def Base: {pl_def_base}", X2+10, Y2+6, fnt, WHITE)
    draw_text(bg, f"Def Buff: {pl_def_buff}", X2+10, Y2+33, fnt, WHITE)
    draw_text(bg, f"Pill: {def_pill}", X2+10, Y2+60, fnt, WHITE)
